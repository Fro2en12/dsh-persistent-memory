...
import { ARCHIVE_SUMMARY_MAX, isCompletedMark } from './write-ops.js';
export function registerTools(ctx, deps, writeOps) {
    const { defaultScope, valueMaxChars, fullMaxChars, allowCredentialReveal, maxItems, store, readItems, writeItems, withLock, searchItems, isSubagentAgent, currentWorkspaceScopes, shouldMaskOutbound, } = deps;
