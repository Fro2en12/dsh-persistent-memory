 ...
 */
export const CREDENTIAL_RE = /\btokens?\b|\bsecrets?\b|\bapi[_-]?keys?\b|\baccess[_-]?keys?\b|\baccountkeys?\b|\bpasswords?\b|\bpasswd\b|密码|口令|密钥|bearer\s+\S{16,}|(?:authorization|proxy-authorization)\s*:\s*(?:basic|bearer|token)\s+[A-Za-z0-9+/=_.-]{12,}|\bbasic\s+[A-Za-z0-9+/=]{16,}|\bsk-[A-Za-z0-9]{16,}|\bsk-ant-[A-Za-z0-9_-]{16,}|\bsk-proj-[A-Za-z0-9_-]{16,}|\b(?:sk|rk|pk)_(?:live|test)_[A-Za-z0-9]{16,}|\bghp_[A-Za-z0-9]{20,}|\bgithub_pat_[A-Za-z0-9_]{20,}|\bglpat-[A-Za-z0-9_-]{16,}|\bxox[abposr]-[A-Za-z0-9-]{10,}|\bnpm_[A-Za-z0-9]{30,}|\bAKIA[0-9A-Z]{16}|\bASIA[0-9A-Z]{16}|eyJ[A-Za-z0-9_-]{8,}\.[A-Za-z0-9_-]{8,}\.[A-Za-z0-9_-]{8,}|BEGIN[ A-Z]*PRIVATE KEY|(?:postgres(?:ql)?|mysql|mariadb|mongodb(?:\+srv)?|redis|rediss|amqp|mssql|sqlserver|ftp|sftp|smtp|ldap):\/\/[^\s:@\/]+:[^\s@\/]+@/i;
