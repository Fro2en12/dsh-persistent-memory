...
import { isCredentialItem, maskCredential, matchesRedactPattern, normalizeScope } from './write-gate.js'
...
import { ARCHIVE_SUMMARY_MAX, createWriteOps, isCompletedMark, MAX_IMPORT_BYTES } from './write-ops.js'
